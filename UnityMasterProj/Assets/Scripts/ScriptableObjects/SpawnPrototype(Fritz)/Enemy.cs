...
public class Enemy : ScriptableObject 
{
	...
	public GameObject CreateEnemyInstance(Vector3 Pos, bool toBeActive)
	{																				//creates enemy prefab at a postion and returns the gameobject, called from enemy spawner
